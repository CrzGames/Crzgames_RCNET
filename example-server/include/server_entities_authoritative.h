...
// IMPORTANT :
// Ces données devraient être en base de données dans un vrai projet, mais pour la simplicité
// de l'exemple, elles sont hardcodées ici.
...
// ============================================================================
// Etat runtime minimal d'une entité (autoritaire serveur)
// ============================================================================
struct EntityState
{
