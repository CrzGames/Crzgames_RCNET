...
// Bundle CA embarque pour la verification TLS libcurl en mode cross-platform.
// Source: https://curl.se/ca/cacert.pem
// Regeneration: telecharger un nouveau cacert.pem puis re-generer ce header.
inline constexpr char kClientHttpTlsCaBundlePem[] =
R"PEM(
##
...
vd21mWRTuKCWs2/iJneRjOBiEAKfNA+k1ZIzUd6+jbqEemA8atufK+ze3gE/bk3lUIbLtK
)PEM"
R"PEM(
/tREDF
...
biBTZXJ2aWNlcykxNTAzBgNVBAMMLE5ldExvY2sgQXJhbnkg
)PEM"
R"PEM(
KENsYXNzIEdvbGQpIEbFkXRhbsO6
...
AAOCAQ8AMIIBCgKCAQEAtITMMxcua5Rsa2FSoOujz3mUTOWUg
)PEM"
R"PEM(
JnLVWREZY9nZOIG41w3SfYvm4SE
...
eXBhc3MgQVMtOTgzMTYzM
)PEM"
R"PEM(
zI3MSAwHgYDVQQDDBdCdXlwYXNzIENsYXNzIDMgUm9vdCBDQTCCAiIw
...
kjMdwLfS7JLIvgm/LCkFbw
)PEM"
R"PEM(
Jrnu+8vyq8W8BQj0FwcYeyTbcEqYSjMq+u7msXi7Kx/mzhkIyIqJdI
...
R"PEM(
9JPrjIgwrvJUXCzO/GU1BBpAAvQxNEP4HteccbiJVMWWXvdMX0h5i89vq
...
BgNVHQ4EFgQUPeYpSJvqB8ohREom3m7e0oPQn1kwCgYIKoZIzj0EAwMDaAAwZQIxAOVpEslu28
)PEM"
R"PEM(
Yx
...
ayBDQSAyMCIYDzIwMTExMDA2MDgzOTU2WhgPMjA0NjEwMDYwODM5NTZaMIGAMQsw
)PEM"
R"PEM(
CQYDVQQGEwJQ
...
aQbLU8uz/mtBzUF+fUwPfHJ5elnNXkoOrJupmHN5fLT0zLm4BwyydFy4x2+IoZCn
)PEM"
R"PEM(
9Kr5v2c69BoV
...
R"PEM(
YmFsU2lnbiBSb290IENBIC0gUjYxEzARBgNVBAoTCkdsb2JhbFNpZ24xEzARBgNVBAMTCkds
...
I5b2P/AgNBbeCsbEBEV5f6f9vtKppa+cxSMq9zwhbL2vj07FOrLzNBL834AaSaTU
)PEM"
R"PEM(
qZX3noleooms
...
Y2F0aW9uIEF1dGhvcml0eTAeFw0xNzA4MjMxOTM1MTBaFw00MjA4MjMxOTM
)PEM"
R"PEM(
1MTBaMIGRMQswCQYD
...
R"PEM(
gU3lzdGVtcyBTLkEuMScwJQYDVQQLEx5DZXJ0dW0gQ2VydGlmaWNhdGlvbiBBdXRob3JpdHkx
...
scasGrz2iTAPBgNVHRMBAf8EBTADAQH/MA4GA1UdDwEB/wQEAwIBBjANBgkqhkiG9w0BAQsFAA
)PEM"
R"PEM(
OC
...
MDIwMB4XDTIwMDIxMTA5NDUwMFoXDTM1MDIxMTA5NDQ1OVowSDELMAkGA1UEBhMCR
)PEM"
R"PEM(
EUxFTATBgNV
...
R"PEM(
CMB3q4S6ILuH5px0CMk7yn2xVdOOurvulGu7t0vzCAxHrRVxgED1cf5kDW21U
SAGKcw==
-----END CERTIFICATE-----
...
==================================
-----BEGIN CERTIFICATE-----
MIIFszCCA5ugAwIBAgIQIZxULej27HF3+k7ow3BXlz
)PEM"
R"PEM(
ANBgkqhkiG9w0BAQwFADBjMQswCQYDVQQG
...
eAIxAKORh/IRM4PDwYqROkwrULG9IpRdNYlzg8WbGf60oenUoWa2AaU2+dhoYSi3dO
)PEM"
R"PEM(
GiMQ==
-----END CERTIFICATE-----
...
inline constexpr size_t kClientHttpTlsCaBundlePemSize = sizeof(kClientHttpTlsCaBundlePem) - 1;
